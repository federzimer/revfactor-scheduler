...
const NAV = [
  ...
  { href: '/admin/faq', label: 'FAQ', superAdminOnly: false },
  { href: '/admin/profile', label: 'My Profile', superAdminOnly: false },
...
export default function AdminHeader() {
  ...
  return (
    <header style={{ backgroundColor: '#F5F4F2', borderBottom: '1px solid #E5E4E0' }}>
      <div className="max-w-5xl mx-auto px-4 py-3 flex flex-wrap md:flex-nowrap items-center gap-x-4 gap-y-3">
        ...
        <nav className="order-3 md:order-none w-full md:w-auto md:flex-1 flex items-center gap-1 overflow-x-auto pb-0.5 md:pb-0">
        ...
        <div className="ml-auto flex items-center gap-3 flex-shrink-0">
          ...
          {session?.user?.image && (
            <img src={session.user.image} alt="" className="hidden sm:block w-9 h-9 rounded-full" />
          )}
          <button
