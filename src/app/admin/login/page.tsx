  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">RevFactor Scheduler</h1>
        ...
        <p className="text-sm text-gray-500 mt-6">Only authorized team members can access this dashboard.</p>
      </div>
    </div>
  );
}
